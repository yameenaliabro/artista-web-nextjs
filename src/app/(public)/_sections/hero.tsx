...
export function HeroSection() {
	return (
		<section className="relative h-[calc(100vh-6rem)]">
			...
			/>
			<div className="absolute inset-0 -z-40 bg-linear-90 from-white to-white/0" />
			<Container className="relative z-50 h-full flex flex-col justify-center">
				<div>
					<h4 className="text-secondary">ARTISTA BLINDS</h4>
				</div>
